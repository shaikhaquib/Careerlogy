...
import com.mmo.careerlogy.Extra.AndroidMultiPartEntity;
import com.mmo.careerlogy.Extra.Constants;
import com.mmo.careerlogy.Extra.FileUtils;
...
import static com.mmo.careerlogy.Network.RetrofitClient.BASE_URL;
    ...
    private class UploadFileToServer extends AsyncTask<Uri, Integer, String> {
        ...
        protected String doInBackground(Uri... uris) {
            ...
            try {
                ...
                String requestURL = BASE_URL + "UploadDocument";
