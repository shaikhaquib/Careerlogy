...
public class AskQuestionStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dropDownCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                final MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(AskQuestionStudent.this);
    ...
    private boolean isValidForm() {
        if (dropDownCategory.getText().toString().equalsIgnoreCase("Choose")) {
            Constants.Alert(AskQuestionStudent.this, "Please Select Question Category");
    ...
    public void getCategory() {
        final Progress progress =new Progress(AskQuestionStudent.this);
        progress.show();
            ...
            public void onResponse(Call<AskQuestionResponse> call, Response<AskQuestionResponse> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body().isError()){
                        Constants.Alert(AskQuestionStudent.this,response.body().getErrormsg());
                    }else {
                        new MaterialAlertDialogBuilder(AskQuestionStudent.this)
                                .setTitle("Success")
