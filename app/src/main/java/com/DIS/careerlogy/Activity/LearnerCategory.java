...
public class LearnerCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learner_category);
        rvStudentCategory = findViewById(R.id.rvStudentCategory);

        rvStudentCategory.setHasFixedSize(true);
        rvStudentCategory.setLayoutManager(new LinearLayoutManager(this));
        ...
        ItemClickListener longClicklistener = new ItemClickListener() {
            @Override
            public void onItemClick(View v, int pos) {
                updateCategory("Update Learners Category", problemCategories.get(pos));
            }
        };


        studentAdapter = new StudentAdapter(this, problemCategories, itemClickListener, longClicklistener);
